$(function () {
  ...
  $(window).scroll(function (evt) {
    ...
    $windowST < 20 ? $("header").addClass("js-at_top") : $("header").removeClass("js-at_top");

    // 置頂箭頭 & 下滑指示箭頭
    $windowST <= 100 ? $(".goTop, .js-arrowDown").addClass("js-at_top") : $(".goTop, .js-arrowDown").removeClass("js-at_top");
  ...
  // 至頂端
  $('.navbar__brand, .goTop').click(function () {
    $('html, body').animate({
      scrollTop: 0
    }, 600);
  ...
  // ID href
  $('.navbar__link, .js-arrowDown').click(function () {
...
var vm1 = new Vue({
  ...
  methods: {
    bg_css: function bg_css(url) {
      return {
        'background-image': "url('" + url + "')"
      };
    },
    work_click: function work_click(id) {
